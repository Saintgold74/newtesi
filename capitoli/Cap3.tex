...
Il framework si articola in quattro moduli interconnessi:
...
\textbf{Generazione del Dataset Sintetico:}
...
\begin{lstlisting}[language=Python, caption={Pipeline di Simulazione Multi-Architettura}]
