...
\textbf{3. Architettura elastica per eventi promozionali:} Sistema che gestisce picchi di carico del 300-500\% durante eventi promozionali\autocite{Osservatorio2024}, richiedendo meccanismi sofisticati di bilanciamento del carico e scalabilità elastica.
...
La prima dimensione riguarda la trasformazione infrastrutturale in corso: il 67\% delle organizzazioni \gls{gdo} europee ha iniziato processi di migrazione da architetture monolitiche centralizzate verso modelli distribuiti basati su servizi\autocite{Gartner2024cloud}. Questa transizione non rappresenta semplicemente un cambio di piattaforma tecnologica, ma richiede un ripensamento fondamentale dei modelli operativi, delle competenze organizzative e delle strategie di gestione del rischio.

Mentre un sistema monolitico tradizionale garantisce le proprietà ACID attraverso transazioni locali con latenze nell'ordine dei microsecondi, un'architettura a \textbf{\gls{microservizi}} deve orchestrare transazioni distribuite che coinvolgono molteplici servizi autonomi. L'acronimo ACID indica le quattro proprietà fondamentali delle transazioni nei database relazionali:
\begin{itemize}
...
\small
\sffamily
\caption[Tipologie di Attacco e Impatti nel Settore GDO]{Tipologie di Attacco e Impatti nel Settore \gls{gdo}}
...
La terza dimensione riguarda la crescente complessità del panorama normativo. L'entrata in vigore simultanea di molteplici normative ha creato un ambiente regolatorio la cui gestione, con approcci tradizionali, può assorbire fino al 2-3\% del fatturato annuale\autocite{ponemon2024compliance}:
...
La sfida non è semplicemente quella di soddisfare requisiti normativi individuali, ma di gestire le interazioni e potenziali conflitti tra framework diversi. Ad esempio, i requisiti di segregazione delle reti imposti da \textbf{\gls{pci-dss}} possono entrare in conflitto con i requisiti di portabilità dei dati del \textbf{\gls{gdpr}}, mentre i requisiti di registrazione e monitoraggio della \gls{nis2} possono creare tensioni con i principi di minimizzazione dei dati del \gls{gdpr}.
...
\vspace{0.3cm}
\textbf{Soluzione Proposta}: Il framework \textbf{\gls{gist}} introduce il concetto di \textbf{"elasticità gerarchica"} dove l'autonomia dei nodi varia dinamicamente in funzione dello stato del sistema globale, implementata attraverso politiche di consenso adattive.
\end{tcolorbox}
...
La seconda area critica riguarda la mancanza di modelli economici specificamente calibrati per il settore retail e validati empiricamente. Mentre esistono framework generali per la valutazione del \textbf{\gls{tco}} e del \textbf{\gls{roi}} delle infrastrutture IT, questi non catturano le peculiarità economiche della GDO:
...
\small
\sffamily
\caption[Confronto tra Approcci Esistenti e Framework GIST]{Confronto tra Approcci Esistenti e Framework \gls{gist} Proposto}
...
\subsection{\texorpdfstring{Architettura della Validazione}{1.4.3 - Architettura della Validazione}}
...
\begin{itemize}
    ...
    \item Database incidenti ENISA: 1.847 eventi documentati\autocite{enisa2024retail}
    \item Sanzioni GDPR: 847 casi nel settore retail\autocite{EDPB2024}
...
\textbf{Modello di Propagazione delle Minacce:} Basato su catene di Markov a tempo continuo (\textbf{\gls{ctmc}}) - processi stocastici che modellano sistemi con transizioni di stato in tempi casuali, particolarmente adatti per la propagazione di compromissioni in reti dove il tempo tra eventi è variabile.
...
\subsection{\texorpdfstring{Metodologia di Aggregazione}{1.4.2 - Metodologia di Aggregazione}}
...
\caption[Struttura della tesi e interdipendenze tra capitoli]{Struttura della tesi e interdipendenze tra capitoli. Il diagramma mostra il flusso logico dalla definizione del problema attraverso l'analisi delle componenti specifiche fino alla sintesi e validazione del framework completo. Le frecce mostrano come ogni capitolo contribuisce al framework finale.}
\label{fig:thesis_structure}
\end{figure}
\begin{itemize}  
    \item  \textbf{Capitolo 2: Evoluzione del Panorama delle Minacce} 
    ...
    \item  \textbf{Capitolo 3: Architetture Cloud-Ibride per la GDO}
    ...
    \caption[Confronto tra architetture tradizionali e cloud-ibrido]{Confronto tra architetture tradizionali e cloud-ibrido in termini di livelli di servizio e struttura dei costi.}
    \label{fig:on-premise-vs-cloud}
    \end{figure}

    \item  \textbf{Capitolo 4: Governance, Conformità e Gestione del Rischio}
    ...
    \item  \textbf{Capitolo 5: Sintesi, Validazione e Direzioni Future}

    Il quinto capitolo presenta una sintesi dei risultati ottenuti, evidenziando le implicazioni pratiche per le organizzazioni del settore GDO. Propone un modello di validazione basato su scenari reali e discute le direzioni future per la ricerca nel campo della sicurezza informatica.
