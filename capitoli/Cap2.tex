...
\refsection 
\chapter{\texorpdfstring{\textbf{Threat Landscape e Sicurezza Distribuita nella \gls{gdo}}}{Capitolo 2 - Threat Landscape e Sicurezza Distribuita nella GDO}}
\label{cap2_threat_landscape}

\section{\texorpdfstring{\textbf{Introduzione e Obiettivi del Capitolo}}{2.1 - Introduzione e Obiettivi del Capitolo}}
...
\subsection{\texorpdfstring{\textbf{Framework di Validazione: Digital Twin \gls{gdo}}}{2.1.1 - Framework di Validazione: Digital Twin GDO}}
...
\section{\texorpdfstring{\textbf{Caratterizzazione della Superficie di Attacco nella \gls{gdo}}}{2.2 - Caratterizzazione della Superficie di Attacco nella GDO}}
...
\section{\texorpdfstring{\textbf{Architetture Difensive Emergenti: il Paradigma \gls{zerotrust} nel Contesto \gls{gdo}}}{2.4 - Architetture Difensive Emergenti: il Paradigma Zero Trust nel Contesto GDO}}
...
\subsection{\texorpdfstring{\textbf{Adattamento del Modello \gls{zerotrust} alle Specificità \gls{gdo}}}{2.4.1 - Adattamento del Modello Zero Trust alle Specificità GDO}}
...
\subsection{\texorpdfstring{\textbf{Framework di Implementazione \gls{zerotrust} per la \gls{gdo}}}{2.4.2 - Framework di Implementazione Zero Trust per la GDO}}
...
\subsubsection{\texorpdfstring{\textbf{\gls{micro-segmentation} Adattiva}}{2.4.2.1 - Micro-segmentazione Adattiva}}
...
\subsubsection{\texorpdfstring{\textbf{Fase 1: Parametrizzazione e Calibrazione}}{2.5.1.1 - Fase 1: Parametrizzazione e Calibrazione}}
...
\subsubsection{\texorpdfstring{\textbf{Fase 4: Validazione Empirica}}{2.5.1.4 - Fase 4: Validazione Empirica}}
...
\subsubsection{\texorpdfstring{\textbf{Riduzione della Superficie di Attacco}}{2.5.2.1 - Riduzione della Superficie di Attacco}}
...
\section{\texorpdfstring{\textbf{Roadmap Implementativa e Prioritizzazione}}{2.6 - Roadmap Implementativa e Prioritizzazione}}
...
\subsubsection{\texorpdfstring{\textbf{Fase 2: Trasformazione del Nucleo (6-18 mesi)}}{2.6.1.2 - Fase 2: Trasformazione del Nucleo (6-18 mesi)}}
...
\subsection{\texorpdfstring{\textbf{Sintesi dei Risultati Chiave e Validazione delle Ipotesi}}{2.7.1 - Sintesi dei Risultati Chiave e Validazione delle Ipotesi}}
...
\subsection{\texorpdfstring{\textbf{Principi di Progettazione Emergenti per la \gls{gdo} Digitale}}{2.7.2 - Principi di Progettazione Emergenti per la GDO Digitale}}
