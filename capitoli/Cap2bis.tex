...
\subsection{Framework di Validazione: Digital Twin GDO}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{thesis_figures/cap2/digital_twin_validation.pdf}
\caption{Output di validazione del Digital Twin GDO. Il sistema genera 
...
Il framework ZT-GDO proposto mitiga specificamente attacchi come Prilex attraverso:
...
3. Crittografia end-to-end che persiste anche durante i fallback
[Dettagliare con riferimenti al Digital Twin per validazione]
...
\begin{enumerate}
    \item 1. Assenza di dati proprietari diretti da catene GDO
    \item 2. Validazione basata su simulazioni, non su implementazioni production
    \item 3. Parametri calibrati su medie di settore, non su specifiche realtà italiane
    \item 4. ROI calcolato in condizioni teoriche ottimali
\end{enumerate}
