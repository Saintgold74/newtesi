...
def create_power_architecture():
    ...
    plt.tight_layout()
    plt.savefig('/home/claude/fig1_power_architecture.png', dpi=300, bbox_inches='tight',
...
def create_network_evolution():
    ...
    plt.tight_layout()
    plt.savefig('/home/claude/fig2_network_evolution.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.show()
    return fig
...
def create_cloud_architecture():
    ...
    plt.tight_layout()
    plt.savefig('/home/claude/fig3_cloud_architecture.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.show()
    return fig
...
def create_edge_architecture():
    ...
    plt.tight_layout()
    plt.savefig('/home/claude/fig4_edge_architecture.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.show()
    return fig
...
def create_gist_framework():
    ...
    plt.tight_layout()
    plt.savefig('/home/claude/fig5_gist_framework.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.show()
    return fig
...
if __name__ == "__main__":
    ...
    print("\nTutte le figure sono state salvate in /home/claude/")
