%!TEX program = xelatex
% File di integrazione figure per il Capitolo 3
% Compilare con: xelatex capitolo3_con_figure.tex
...
% Definizioni acronimi per esempio
\newacronym{gdo}{GDO}{Grande Distribuzione Organizzata}
\newacronym{edge}{Edge}{Edge Computing}
