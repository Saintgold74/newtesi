...
Figure mancante per il Capitolo 1
"""
...
def create_methodology_figure():
    """
    Crea la Figura 1.3: Schema metodologico della ricerca
    """
    ...
    # 5 Output principali con icone
    outputs = [
        {'x': 2.5, 'icon': '📊', 'title': 'Framework GIST', 
         'desc': 'Modello integrato\n4 dimensioni'},
        {'x': 4.5, 'icon': '🔧', 'title': 'ASSA-GDO', 
         'desc': 'Algoritmo scoring\nr=0.82'},
        {'x': 6.5, 'icon': '💻', 'title': 'Digital Twin', 
         'desc': 'Simulatore\nvalidato'},
        {'x': 8.5, 'icon': '📈', 'title': 'ML Predictor', 
         'desc': 'Sistema predittivo\nAUC=0.89'},
        {'x': 10.5, 'icon': '📚', 'title': 'GDO-Bench', 
    ...
    for output in outputs:
        ...
        ax.text(output['x'], 1.7, output['icon'], ha='center', va='center',
                fontsize=16)
...
def create_simple_methodology():
    """
    Versione alternativa più semplice e lineare
    """
...
if __name__ == "__main__":
    ...
    fig1.savefig('/mnt/user-data/outputs/thesis_figures/cap1/fig_1_3_methodology.pdf',
                dpi=300, bbox_inches='tight', format='pdf')
    fig1.savefig('/mnt/user-data/outputs/thesis_figures/cap1/fig_1_3_methodology.png',
    ...
    fig2.savefig('/mnt/user-data/outputs/thesis_figures/cap1/fig_1_3_methodology_simple.pdf',
                dpi=300, bbox_inches='tight', format='pdf')
    fig2.savefig('/mnt/user-data/outputs/thesis_figures/cap1/fig_1_3_methodology_simple.png',
                dpi=150, bbox_inches='tight', format='png')
