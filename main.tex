...
\usepackage[acronym,toc]{glossaries} % 'numberedsection' is not a standard option and can be removed.
\loadglsentries{glossario} % Load definitions from glossario.tex (do not include the extension)
\makeglossaries
